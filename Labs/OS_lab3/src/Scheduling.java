...
public class Scheduling {
    ...
    private static String resultsFile = "res/Summary-Results";
        ...
        try {
            ...
            while ((line = in.readLine()) != null) {
                ...
                if (line.startsWith("process")) {
                    ...
                    processVector.addElement(new sProcess(cputime, ioblocking, 0, 0, 0,Common.getRandomPriority()));
                }
    ...
    public static void main(String[] args) {
        ...
        if (processVector.size() < processnum) {
            ...
            while (processVector.size() < processnum) {
                ...
                processVector.addElement(new sProcess(cputime, i * 100, 0, 0, 0, Common.getRandomPriority()));
                i++;
            }
        }
        ...
        try {
            ...
            out.println("OC.Process #\tCPU Time\tIO Blocking\tCPU Completed\tCPU Blocked");
